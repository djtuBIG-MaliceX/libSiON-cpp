...
Ref<SiOPMWavePCMData> SiONData::set_pcm_wave(int p_index, const Ref<SampleData> &p_data, double p_sampling_note, int p_key_range_from, int p_key_range_to, int p_src_channel_count, int p_channel_count) {
...
Ref<SiOPMWaveSamplerData> SiONData::set_sampler_wave(int p_index, const Ref<SampleData> &p_data, bool p_ignore_note_off, int p_pan, int p_src_channel_count, int p_channel_count) {
