...
void SiEffectDownsampler::_process_mono(std::vector<double> *r_buffer, int p_start_index, int p_length) {
...
void SiEffectDownsampler::_process_stereo(std::vector<double> *r_buffer, int p_start_index, int p_length) {
...
int SiEffectDownsampler::process(int p_channels, std::vector<double> *r_buffer, int p_start_index, int p_length) {
...
void SiEffectDownsampler::set_by_mml(std::vector<double> p_args) {
