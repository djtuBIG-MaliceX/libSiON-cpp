...
void SiEffectStereoReverb::set_params(double p_delay1, double p_delay2, double p_feedback, double p_wet) {
	...
	double delay2 = std::clamp(p_delay2, 0.01, 0.99);
	...
	double feedback = std::clamp(p_feedback, -0.99, 0.99);
...
void SiEffectStereoReverb::_process_channel(std::vector<double> *r_buffer, int p_buffer_index, std::vector<double> *r_delay_buffer) {
...
void SiEffectStereoReverb::set_by_mml(std::vector<double> p_args) {
