...
public:
	...
	sion::String get_name() const { return _name; }
	void set_name(const sion::String &p_name) { _name = p_name; }
	...
	sion::String get_mml(int p_index, SiONChipType p_chip_type = (SiONChipType)-1, bool p_append_postfix = true) const;
	int set_by_mml(sion::String p_mml);

	Ref<SiOPMWaveTable> set_wave_table(std::vector<double> *p_data);

	Ref<SiOPMWavePCMData> set_pcm_voice(const Ref<SampleData> &p_data, int p_sampling_note = 69, int p_src_channel_count = 2, int p_channel_count = 0);
	Ref<SiOPMWavePCMData> set_pcm_wave(int p_index, const Ref<SampleData> &p_data, int p_sampling_note = 69, int p_key_range_from = 0, int p_key_range_to = 127, int p_src_channel_count = 2, int p_channel_count = 0);
	Ref<SiOPMWaveSamplerData> set_sampler_voice(const Ref<SampleData> &p_data, bool p_ignore_note_off = false, int p_channel_count = 2);
	Ref<SiOPMWaveSamplerData> set_sampler_wave(int p_index, const Ref<SampleData> &p_data, bool p_ignore_note_off = false, int p_pan = 0, int p_src_channel_count = 2, int p_channel_count = 0);
